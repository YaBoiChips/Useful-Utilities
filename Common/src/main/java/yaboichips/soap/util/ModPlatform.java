...
public interface ModPlatform {
    ...
    <P extends SoapServer2ClientPacket> void sendToClient(ServerPlayer player, P packet);

    <P extends SoapServer2ClientPacket> void sendToServer(P packet);
    ...
    ResourceLocation getResourceLocation(String namespace, String sound);
    ...
    default <P extends SoapServer2ClientPacket> void sendToAllClients(List<ServerPlayer> players, P packet) {
